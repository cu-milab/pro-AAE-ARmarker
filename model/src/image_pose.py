...
class image_converter:
    ...
    def SaveImage(self, num):
        ...
        cv2.imwrite("../img_0131/sisei40/"+ str(num).zfill(6) +".png", self.color_image)
...
if __name__ == '__main__':
    ...
    model_list = ["AR0_20","AR0_30","AR0_40","AR1_20","AR1_30","AR1_40"]#"ARt_20",]
    ...
    min_xyz = [0.8,  0,  0.5]
    max_xyz = [0.8,  0,  0.5]
    min_rpy = [-0.50, -0.50, -0.5490]
    max_rpy = [0.50, 0.50, 1.3425]

    while not rospy.is_shutdown():

        # if model_name == "AR0_20":
        #     seed_number = 1
        #     model_name_1 =  "AR0_20_"
        #     cx = 0.8
        # elif model_name == "AR0_30":
        #     seed_number = 2
        #     model_name_1 = "AR0_30_"
        #     cx = 0.81
        # elif model_name == "AR0_50":
        #     seed_number = 3
        #     model_name_1 = "AR0_50_"
        #     cx = 0.88
        # elif model_name == "AR1_20":
        #     seed_number = 1
        #     model_name_1 =  "AR1_20_"
        #     cx = 0.82
        # elif model_name == "AR1_30":
        #     seed_number = 2
