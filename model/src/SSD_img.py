...
class image_converter:
    ...
    def SaveImage(self, num):
        ...
        cv2.imwrite("../img_0115/SSD/"+ str(num).zfill(6) +".png", self.color_image)
...
if __name__ == '__main__':
    ...
    model_list = ["ARt0_20","ARt0_30","ARt0_40","ARt1_20","ARt1_30","ARt1_40","ARt2_20","ARt2_30","ARt2_40"]#"ARt_20","AR5_20","AR5_30","AR5_40",]
    ...
    for model_name in model_list:
        ...
        # 乱数範囲
        min_xyz = [0.4,  -0.24,  0.35]
        max_xyz = [0.8,  0.24,  0.65]
        min_rpy = [0, -0.70, -0.23]
        max_rpy = [6, 0.70, 0.23]

        while not rospy.is_shutdown():

            if model_name == "ARt0_20":
                seed_number = 0
                model_name_1 = "AR0_20_"
                cx = 0.8
                ct = 0
            elif model_name == "ARt0_30":
                seed_number = 1
                model_name_1 =  "AR0_30_"
                cx = 0.85
                ct = 0
            elif model_name == "ARt0_40":
                seed_number = 2
                model_name_1 = "AR0_40_"
                cx = 0.9
                ct = 0

            elif model_name == "ARt1_20":
                seed_number = 3
                model_name_1 = "AR1_20_"
                cx = 0.8
                ct = 0
            elif model_name == "ARt1_30":
                seed_number = 4
                model_name_1 =  "AR1_30_"
                cx = 0.85
                ct = 0
            elif model_name == "ARt1_40":
                seed_number = 5
                model_name_1 = "AR1_40_"
                cx = 0.9
                ct = 0
            elif model_name == "ARt2_20":
                seed_number = 6
                model_name_1 =  "AR2_20_"
                cx = 0.8
                ct = 0
            elif model_name == "ARt2_30":
                seed_number = 7
                model_name_1 =  "AR2_30_"
                cx = 0.85
                ct = 0
            elif model_name == "ARt2_40":
                seed_number = 8
                model_name_1 = "AR2_40_"
                cx = 0.9
                ct = 0
            else:
                seed_number = 85
