...
class image_converter:
    ...
    def SaveImage(self, num):
        ...
        cv2.imwrite("../img_0115/AR5-t/"+ str(num).zfill(6) +".png", self.color_image)
...
if __name__ == '__main__':
    ...
    model_list = ["ARt5_20","ARt5_30","ARt5_40"]#"ARt_20","AR5_20","AR5_30","AR5_40",]
    ...
    for model_name in model_list:
        ...
        max_xyz = [0.8,  0,  0.5]
        min_rpy = [0, -0.70, -0.23]
        max_rpy = [5.5, 0.70, 0.23]

        while not rospy.is_shutdown():


            if model_name == "AR5_40":
                seed_number = 83
                model_name_1 = "AR5_40_"
                cx = 0.85
                ct = 0
            elif model_name == "AR5_20":
                seed_number = 84
                model_name_1 =  "AR5_20_"
                cx = 0.85
                ct = 0
            elif model_name == "AR5_30":
                seed_number = 85
                model_name_1 = "AR5_30_"
                cx = 0.83
                ct = 0

            elif model_name == "ARt5_40":
                seed_number = 83
                model_name_1 = "ARt5_40_"
                cx = 0.85
                ct = 0
            elif model_name == "ARt5_20":
                seed_number = 84
                model_name_1 =  "ARt5_20_"
                cx = 0.85
                ct = 0
            else:
                seed_number = 85
                model_name_1 = "ARt5_30_"
                cx = 0.83
                ct = 0

            random.seed(seed_number)
            for i in range(ct,2000):
