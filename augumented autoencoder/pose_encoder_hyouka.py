...
class DB(Dataset):
    ...
    def getImage(self, path):    #
        ...
        pick_name = path.replace("./datasets/AAE_pose/SSD_hyouka/0_30/","")
        ...
        for batch in poseloader:
            ...
            for i in range(len(z)): #100回
                for n in range(128):  #128回
                    ...
                    save_name = save_name.replace("./datasets/AAE_pose/SSD_hyouka/0_30/","")

                    with open(args.name+ "/SSD_0_30_t/" +save_name+".txt","a") as f:
